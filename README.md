# Panzer-OHM-Gauge-VB6
 ...
 My current VB6/RC6 PSD program being worked upon now, just the temperature gauge at the moment, very much a work-in-progress, about 20% complete, awaiting the other four gauges plus the information and icao entry forms, smooth rotation to the temperature pointer, testing on Windows XP and Win7 32bit and some multi-monitor checking, completion of the CHM help file and the creation of the setup.exe. This Panzer widget is based upon the Yahoo/Konfabulator widget of the same visual design and very similar operation.
