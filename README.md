# Panzer-OHM-Gauge-VB6
 ...
 My current VB6/RC6 PSD program being worked upon now, about 70% complete, awaiting addition of WMI queries to extract temperature information, smooth rotation to the temperature pointer, enabling the glowing lamps, testing on Windows XP and Win7 32bit and some multi monitor checking, completion of the CHM help file and the creation of the setup.exe. This Panzer widget is based upon the Yahoo widget of the same visual design and very similar operation.
