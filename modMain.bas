...
'    overlayWidget.ZoomDirection = gblScrollWheelDirection
    ...
    'If gblCurrentSensor <> "" Then overlayWidget.thisSensor = gblCurrentSensor
    'gblCurrentSensor = "0"
...
'        gblClockFaceSwitchPref = fGetINISetting(location, "clockFaceSwitchPref", gblSettingsFile)
        ...
        ' other
        gblClockHighDpiXPos = fGetINISetting("Software\PzOHMGauge", "clockHighDpiXPos", gblSettingsFile)
        gblClockHighDpiYPos = fGetINISetting("Software\PzOHMGauge", "clockHighDpiYPos", gblSettingsFile)
        
        gblClockLowDpiXPos = fGetINISetting("Software\PzOHMGauge", "clockLowDpiXPos", gblSettingsFile)
        gblClockLowDpiYPos = fGetINISetting("Software\PzOHMGauge", "clockLowDpiYPos", gblSettingsFile)
...
Private Sub getToolSettingsFile()
    ...
    gblSettingsDir = fSpecialFolder(feUserAppData) & "\PzOHMGauge" ' just for this user alone
