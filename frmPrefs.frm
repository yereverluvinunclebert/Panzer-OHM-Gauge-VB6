...
Private Sub cmbCurrentSensor_Click()
    ...
    PzGCurrentSensor = cmbCurrentSensor.List(cmbCurrentSensor.ListIndex)
    sPutINISetting "Software\PzOHMGauge", "currentSensor", PzGCurrentSensor, PzGSettingsFile
...
Private Sub btnSelectMonitor_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    If PzGEnableBalloonTooltips = "1" Then CreateToolTip btnSelectMonitor.hwnd, "Select the location of your temperature-monitoring software. Enter the full folder path and program name: eg. C:\Program Files (x86)\OpenHardwareMonitor\OpenHardwareMonitor.exe. (You can use Libre version of OHM with the dedicated LHM widget).", _
...
Private Sub chkDpiAwareness_Click()
    ...
    If prefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\PzOHMGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzOHMGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
...
Private Sub chkWidgetHidden_Click()
   On Error GoTo chkWidgetHidden_Click_Error
    ...
    sPutINISetting "Software\PzOHMGauge", "widgetHidden", PzGWidgetHidden, PzGSettingsFile
...
'    PzGMainDaylightSaving = cmbMainDaylightSaving.ListIndex
    ...
    PzGTemperatureScale = cmbTemperatureScale.ListIndex
    PzGMonitoringProgram = txtMonitoringProgram.Text
...
'    End If
    ...
    If fFExists(PzGSettingsFile) Then
        sPutINISetting "Software\PzOHMGauge", "enableTooltips", PzGEnableTooltips, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "enableBalloonTooltips", PzGEnableBalloonTooltips, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "showTaskbar", PzGShowTaskbar, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
        ...
        sPutINISetting "Software\PzStorageGauge", "monitoringProgram", PzGMonitoringProgram, PzGSettingsFile
        
        
        'sPutINISetting "Software\PzOHMGauge", "clockFaceSwitchPref", PzGClockFaceSwitchPref, PzGSettingsFile
        
        sPutINISetting "Software\PzOHMGauge", "aspectHidden", PzGAspectHidden, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "widgetPosition", PzGWidgetPosition, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "widgetLandscape", PzGWidgetLandscape, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "widgetPortrait", PzGWidgetPortrait, PzGSettingsFile

        sPutINISetting "Software\PzOHMGauge", "prefsFont", PzGPrefsFont, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "clockFont", PzGClockFont, PzGSettingsFile
        
        sPutINISetting "Software\PzOHMGauge", "prefsFontSizeHighDPI", PzGPrefsFontSizeHighDPI, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "prefsFontSizeLowDPI", PzGPrefsFontSizeLowDPI, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "prefsFontItalics", PzGPrefsFontItalics, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "prefsFontColour", PzGPrefsFontColour, PzGSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\PzOHMGauge", "windowLevel", PzGWindowLevel, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "preventDragging", PzGPreventDragging, PzGSettingsFile
        
        sPutINISetting "Software\PzOHMGauge", "opacity", PzGOpacity, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "widgetHidden", PzGWidgetHidden, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "hidingTime", PzGHidingTime, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "ignoreMouse", PzGIgnoreMouse, PzGSettingsFile
        
        
        sPutINISetting "Software\PzOHMGauge", "startup", PzGStartup, PzGSettingsFile

        sPutINISetting "Software\PzOHMGauge", "enableSounds", PzGEnableSounds, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "lastSelectedTab", PzGLastSelectedTab, PzGSettingsFile
        
        sPutINISetting "Software\PzOHMGauge", "debug", PzGDebug, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "dblClickCommand", PzGDblClickCommand, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "openFile", PzGOpenFile, PzGSettingsFile
        sPutINISetting "Software\PzOHMGauge", "defaultEditor", PzGDefaultEditor, PzGSettingsFile
...
'    cmbMainDaylightSaving.ListIndex = Val(PzGMainDaylightSaving)
    ...
    txtMonitoringProgram.Text = PzGMonitoringProgram
...
'    panzerPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    sPutINISetting "Software\PzOHMGauge", "skinTheme", PzGSkinTheme, PzGSettingsFile
