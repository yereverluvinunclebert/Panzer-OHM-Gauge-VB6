   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":71D7
            Left            =   1530
            List            =   "frmPrefs.frx":71D9
            Style           =   2  'Dropdown List
            TabIndex        =   54
...
btnSelectMonitor_Click_Error:
    ...
    With Err
         If .Number <> 0 Then
            MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnSelectMonitor_Click of Form panzerPrefs"
            Resume Next
          End If
    End With
...
Private Sub btnSelectMonitor_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    If gblEnableBalloonTooltips = "1" Then CreateToolTip btnSelectMonitor.hwnd, "Select the location of your temperature-monitoring software. Enter the full folder path and program name: eg. C:\Program Files (x86)\OpenHardwareMonitor\OpenHardwareMonitor.exe. (You can use Libre version of OHM with the dedicated LHM widget).", _
...
btnSelectMonitor_MouseMove_Error:
     ...
     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure btnSelectMonitor_MouseMove of Form panzerPrefs"
End Sub
...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzOHMGauge", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
...
'    End If
    ...
    If fFExists(gblSettingsFile) Then
        sPutINISetting "Software\PzOHMGauge", "enableTooltips", gblEnableTooltips, gblSettingsFile
        sPutINISetting "Software\PzOHMGauge", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
        sPutINISetting "Software\PzOHMGauge", "enableBalloonTooltips", gblEnableBalloonTooltips, gblSettingsFile
        ...
        'sPutINISetting "Software\PzOHMGauge", "clockFaceSwitchPref", gblClockFaceSwitchPref, gblSettingsFile
        ...
        sPutINISetting "Software\PzOHMGauge", "clockFont", gblClockFont, gblSettingsFile
        ...
        sPutINISetting "Software\PzOHMGauge", "defaultEditor", gblDefaultEditor, gblSettingsFile
...
'    cmbMainDaylightSaving.ListIndex = Val(gblMainDaylightSaving)
    ...
    txtDefaultEditor.Text = gblDefaultEditor
    lblGitHub.Caption = "You can find the code for the Panzer OHM Gauge on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/ Panzer-OHM-Gauge-VB6"
...
'        sliAnimationInterval.ToolTipText = "Adjust to make the animation smooth or choppy. Any adjustment in the interval takes place instantly. Lower values are smoother but the smoother it runs the more OHM it uses."
...
'        cmbMainDaylightSaving.ToolTipText = "Select and activate Daylight Savings Time for your area."
        ...
        cmbTickSwitchPref.ToolTipText = "The movement of the hand can be set to smooth or regular flicks, the smooth movement uses slightly more OHM."
